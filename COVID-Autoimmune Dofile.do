import delimited "/rds/projects/s/subramaa-covid/COVID_Autoimmune_AllPracs20220311110715.csv"
...
foreach var in od_mediType1DM  od_medisle od_medimyasthenia_gravis od_mediautoimmunethyroid od_medisjogrenssyndrome od_medivitiligo od_medirheumatoidarthritis od_medipsoriasis od_mediperniciousanaemia od_mediinflammatory_bowel_as9 od_medicoeliac_disease{
...
gen O_AID = 0
replace O_AID = 1 if O_Type1DM == 1 | O_sle == 1 | O_myasthenia_gravis == 1 | O_autoimmunethyroid == 1 |  O_sjogrenssyndrome == 1 | O_vitiligo == 1 | O_rheumatoidarthritis == 1 | O_psoriasis == 1 | O_perniciousanaemia == 1 | O_inflammatory_bowel ==1 | O_coeliac_disease == 1
gen OD_AID = min(OD_Type1DM, OD_sle, OD_myasthenia_gravis, OD_autoimmunethyroid, OD_sjogrenssyndrome, OD_vitiligo, OD_rheumatoidarthritis, OD_psoriasis, OD_perniciousanaemia, OD_inflammatory_bowel, OD_coeliac_disease)
...
stset PY_inflammatory_bowel_as9, failure(O_inflammatory_bowel==1)
stcox exposed
stcox exposed agecat BMIcat COV_SmokingStatus COV_sex B_Infection B_Medication Ethnicity
bysort exposed: tab O_inflammatory_bowel
ir O_inflammatory_bowel exposed PY_inflammatory_bowel_as9
